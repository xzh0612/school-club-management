...
import com.club.dto.RecruitmentPlanRequest;
...
public class RecruitmentPlanController {
    ...
    @PostMapping
    public Result<RecruitmentPlan> create(@Valid @RequestBody RecruitmentPlanRequest requestBody, HttpServletRequest request) {
        RecruitmentPlan plan = requestBody.toPlan();
    ...
    @PutMapping("/{id}")
    public Result<RecruitmentPlan> update(@PathVariable Integer id, @Valid @RequestBody RecruitmentPlanRequest requestBody, HttpServletRequest request) {
        RecruitmentPlan plan = requestBody.toPlan();
